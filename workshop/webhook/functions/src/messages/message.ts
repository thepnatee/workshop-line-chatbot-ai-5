export const welcomeMessage = (displayName: string) => {
  return {
    type: 'text',
...
export const welcomeBack = (displayName: string) => {
  return {
    type: 'text',
    text: `อ้าววคุณ ${displayName} สบายดีไหมครับ`,
    sender: {
      name: 'BOT',
      iconUrl: 'https://cdn-icons-png.flaticon.com/512/10176/10176915.png ',
    },
...
export const postbackDate = (date: string) => {
  return {
    type: 'text',
...
export const welcomeRegister = (displayName: string) => {
  return {
    type: 'text',
    text: `ยินดีต้อนรับคุณ ${displayName}`,
    sender: {
