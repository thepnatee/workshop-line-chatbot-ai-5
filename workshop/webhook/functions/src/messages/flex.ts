export const flexProfile = (pictureUrl: string, name: string) => {
  return {
    type: 'flex',
    altText: 'Profile',
    contents: {
...
export const unixtime = (time: number) => {
  return {
    type: 'flex',
    altText: 'UnixTime',
    contents: {
...
export function createBookingListFlex(bookings: any[]) {
  return {
    type: 'flex',
    altText: '📅 ตารางนัดหมายของคุณ',
    contents: {
      type: 'carousel',
      contents: bookings.map((booking) => ({
        ...
        body: {
          ...
          layout: 'vertical',
          spacing: 'md',
          backgroundColor: '#F0F5F9', // สีพื้นหลังอ่อน ๆ
          paddingAll: '16px',
          contents: [
            {
              type: 'text',
              text: `🗓 ${formatDateThai(booking.datetime)}`,
              weight: 'bold',
              size: 'lg',
              color: '#1DB446',
              margin: 'none',
            ...
            {
              type: 'text',
              text: `${formatTime(booking.datetime)} น.`,
              size: 'md',
              color: '#333333',
            },
            {
            ...
            {
              type: 'text',
              text: `📍 ${booking.location || 'ไม่ระบุสถานที่'}`,
              size: 'sm',
              color: '#666666',
              wrap: true,
              margin: 'sm',
          ...
          contents: [
            {
              ...
              action: {
                type: 'message',
                label: '❌ ยกเลิกนัด',
                text: `ยกเลิกนัดหมาย ${booking.eventId}`,
              },
              style: 'primary',
              color: '#FF5A5F',
            },
...
function formatDateThai(datetime: string) {
